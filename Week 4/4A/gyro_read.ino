...
public:
    ...
    void update() {
        ...
        if (currentGesture != previousGesture) {
            ...
            performGestureAction(currentGesture);  // Call to the newly defined function
...
private:
    ...
    // Define the performGestureAction function here
    void performGestureAction(int gesture) {
        switch (gesture) {
            case GESTURE_ONE:
                // Action for forward tilt
                Serial.println("Action for Forward Tilt");
                // Example: Turn on an LED or trigger a motor
                break;
            case GESTURE_TWO:
                // Action for backward tilt
                Serial.println("Action for Backward Tilt");
                // Example: Turn off the LED or reverse motor
                break;
            case NO_GESTURE:
                // No action
                break;
